...
const postKey = 'gyosei-quiz-one.posts'
const savedKey = 'gyosei-quiz-one.saved'
const items = [
  {
    "id": "gyosei-quiz-one-1",
    "title": "Nagoya admin law opportunity",
    "category": "admin law",
    "area": "Nagoya",
    "summary": "One-question learning app for administrative scrivener exams with AI explanations, weak-point review and streaks. This page is designed as a searchable seed record with review intent, update status and conversion context.",
    "score": 92,
    ...
    "revenue": "paid question bank"
  },
  {
    "id": "gyosei-quiz-one-2",
    "title": "Tokyo civil law opportunity",
    "category": "civil law",
    "area": "Tokyo",
    "summary": "One-question learning app for administrative scrivener exams with AI explanations, weak-point review and streaks. This page is designed as a searchable seed record with review intent, update status and conversion context.",
    "score": 85,
    ...
    "revenue": "premium review plan"
  },
  {
    "id": "gyosei-quiz-one-3",
    "title": "Osaka constitution opportunity",
...
function App() {
  ...
  const [form, setForm] = useState({ title: '', category: 'admin law', body: '' })
  ...
  function submitPost(event) {
    ...
    setForm({ title: '', category: 'admin law', body: '' })
  }
  ...
  return (
    <main className="app-shell">
      <section className="hero">
        <div>
          <span className="brand">gyoseiquiz.jp / gyosei-quiz-one</span>
          <h1>Gyosei Quiz One</h1>
          <p>One-question learning app for administrative scrivener exams with AI explanations, weak-point review and streaks.</p>
        </div>
        <aside className="answer-box">
          <small>AI overview answer</small>
          <strong>Gyosei Quiz One helps users compare, verify and act faster.</strong>
      ...
      <section className="ugc-section">
        ...
        <form className="ugc-form" onSubmit={submitPost}>
          ...
          <select value={form.category} onChange={(event) => setForm({ ...form, category: event.target.value })}>
            {["admin law","civil law","constitution","commercial law","general knowledge"].map((item) => <option key={item}>{item}</option>)}
          </select>
